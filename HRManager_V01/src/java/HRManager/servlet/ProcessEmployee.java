...
import HRManager.bol.EmpAdd;
import HRManager.bol.EmpDelete;
import HRManager.bol.EmpEdit;
import HRManager.bol.EmpGetById;
...
public class ProcessEmployee extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        EmpGetById empGetById = new EmpGetById();
        ...
        if (lName == null || fName == null) {
            if (action == null || action.equals("add")) {
                ...
                e = empGetById.getByID(Integer.parseInt(id));
            }
